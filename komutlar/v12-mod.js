...
exports.run = async(client, message, args, ops) => {
    ...
    let abonerole = message.guild.roles.find(`name`, "⌭  v12 Moderasyon Altyapı");
    if (!abonerole) return message.reply("Rol Bulunamadı Lütfen 'Moderasyon' Adıyla Rol Oluşturunuz.");
    ...
    let aboneembed = new Discord.RichEmbed()
        .setTitle("<a:bildiri:770588596942929921> ・ v12 Moderasyon Altyapı Rolü Verildi")
        .setColor('BLUE')
        .addField("<a:yumuakok:770591161672531978> ・ v12 Moderasyon Altyapı Rolü Veren Yetkili", `${message.author.tag}`, true)
        .addField("<a:yumuakok:770591161672531978> ・ v12 Moderasyon Altyapı Rolü Alan Kullanıcı", `${vUser}`, true)
       .setTimestamp();
